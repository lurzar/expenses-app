...
namespace App\Modules\Planning\Livewire;
...
class Planning extends Component
{
    ...
    public function updatedSalary($value): void
    {
    ...
    public function updatedSavingRate($value): void
    {
    ...
    public function addSavingField($data): void
    {
        $this->savings_fields->push(array_pop($data) + 1);
    }

    public function removeSavingField($data): void
    {
        unset($this->savings_values[$data]);
        $this->savings_fields->forget($data);
    }

    public function updatedSavingsValues(): void
    {
    ...
    public function addCommitmentField($data): void
    {
        $this->commitments_fields->push(array_pop($data) + 1);
    }

    public function removeCommitmentField($data): void
    {
        unset($this->commitments_values[$data]);
        $this->commitments_fields->forget($data);
    }

    public function updatedCommitmentsValues(): void
    {
    ...
    public function addOtherField($data): void
    {
        $this->others_fields->push(array_pop($data) + 1);
    }

    public function removeOtherField($data): void
    {
        unset($this->others_values[$data]);
        $this->others_fields->forget($data);
    }

    public function updatedOthersValues(): void
    {
