...
| Domain language and financial rules | [`docs/domain/expense-planning.md`](domain/expense-planning.md) | Current behavior and approved integrity target | Domain owner; update when financial meaning, lifecycle, or invariants change. |
