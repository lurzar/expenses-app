...
| Authorization and Admin contract | [`Authorization contract`](codebase/AUTHORIZATION.md) and [`ADR 0002`](decisions/0002-modular-laravel-authorization.md) | Accepted for v2.2.0 by #131; runtime implementation planned by #13 and its dependent Admin issues | Authorization/system owner; update when roles, permissions, policies, ownership, Admin access, capability props, privileged auditing, or provisioning changes. |
