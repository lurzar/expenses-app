...
| Authorization and Admin contract | [`Authorization contract`](codebase/AUTHORIZATION.md) and [`ADR 0002`](decisions/0002-modular-laravel-authorization.md) | Authorization foundation implemented by #13; Admin UI and super-admin lifecycle remain issue-backed work | Authorization/system owner; update when roles, permissions, policies, ownership, Admin access, capability props, privileged auditing, or provisioning changes. |
