...
| Stack, structure, architecture, conventions, integrations, testing, and concerns | [`docs/codebase/STACK.md`](codebase/STACK.md) and its companion references | Current | Technical owner; update when architecture, module boundaries, integrations, supported tooling, testing, or verified concerns change. |
