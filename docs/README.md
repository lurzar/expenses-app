...
| Domain language and financial rules | [`docs/domain/expense-planning.md`](domain/expense-planning.md) | Current behavior and proposed integrity target | Domain owner; update when financial meaning, lifecycle, or invariants change. |
| UI/UX system, accessibility, responsive shell, and data visualization | [`docs/design/ui-system.md`](design/ui-system.md) | Approved implementation target; current runtime migration pending | Product/design owner; update when navigation, semantic tokens, accessibility, responsive behavior, component contracts, or visualization policy changes. |
