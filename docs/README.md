...
| Authorization and Admin contract | [`Authorization contract`](codebase/AUTHORIZATION.md) and [`ADR 0002`](decisions/0002-modular-laravel-authorization.md) | Authorization foundation implemented by #13, super-admin lifecycle by #132, Admin shell by #40, and user-role management by #133 | Authorization/system owner; update when roles, permissions, policies, ownership, Admin access, capability props, privileged auditing, or provisioning changes. |
...
| Authorization and Admin operations | [`Authorization/Admin runbook`](operations/authorization-admin.md) | Planned by #135 | Authorization/system owner; update when role mappings, Admin operations, cache behavior, auditing, deployment, or rollback changes. |
