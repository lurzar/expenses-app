...
| Architecture decisions | [`docs/decisions/`](decisions/) | Current from ADR 0001 | Decision owner; add an ADR when an approved choice changes architecture, data, interfaces, or operations. |
